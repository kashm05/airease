...
<body>
    <header>
        ...
        <ul class="nav__links">
            ...
            <li class="link1"><a href="#">ABOUT</a></li>
            <li class="link1"><a href="#">MY FLIGHTS</a></li>
            <li class="link1"><a href="#">FEEDBACK</a></li>
        </ul>
        <div class="login">
            <button class="btn"><a href="Logged-in Homepage.html">Login</a></button>
        </div>
    </header>
    <br><br><br>
            ...
            <div id="main-box-Arrived">
                ...
                ?> 
                    <div>
                        ...
                        ?>
                        <div>
                            <p style="position:absolute;top:142px;left:35px;font-size:20px;color:red;">No Seats Available</p>
                        </div>
                        <?php
                            }
                            else
    ...
    <!-- <footer class="footer">
        <div class="section__container footer__bar1">
            ...
            <div class="social">
                ...
                <div class="n_logo"><img src="assets/aireaselogoinwhite.png"></div>
            </div>
        </div>
    </footer> -->
</body>
