<?php
    ...
    if (isset($_POST['single']))
    {
        ...
        if (mysqli_num_rows($result1)>0)
        {
            ...
            if ($nop==1)
            {
                ...
                $message .= "Your AirEase ticket from $src to $dest of prn no : $prn has been successfully canceled.Refund will be initiated within 24 hours and your payment will be credited..\r\n\r\n";
                $message .= "Thank you for choosing AirEase.\r\n";
                $headers = "From: kashafmaniyar6@gmail.com\r\n";
                $headers .= "Reply-To: kashafmaniyar6@gmail.com\r\n";
            ...
            else
            {
                ...
                $subject = "Ticket Cancellation Confirmation";
                $message = "Dear User $name,\r\n\r\n";
                $message .= "Your AirEase Ticket from $src to $dest of PRN No : $prn has been Successfully Cancelled.Refund will be Initiated within 24 hours and your Funds will be Credited..\r\n\r\n";
                $message .= "Thank you for choosing AirEase.\r\n";
                $headers = "From: kashafmaniyar6@gmail.com\r\n";
                $headers .= "Reply-To: kashafmaniyar6@gmail.com\r\n";
                $headers .= "Content-Type: text/plain; charset=UTF-8\r\n";
    ...
    else
    {
        ...
        $subject = "Ticket Cancellation Confirmation";
        $message = "Dear User $name,\r\n\r\n";
        $message .= "Your AirEase ticket from $src to $dest of prn no : $prnString has been successfully canceled.Refund will be initiated within 24 hours and your payment will be credited..\r\n\r\n";
        $message .= "Thank you for choosing AirEase.\r\n";
        $headers = "From: kashafmaniyar6@gmail.com\r\n";
        $headers .= "Reply-To: kashafmaniyar6@gmail.com\r\n";
        $headers .= "Content-Type: text/plain; charset=UTF-8\r\n";
