    ...
    <section class="payment">
        <div class="container">
            ...
            <div id="upiPaymentForm" class="payment-form" style="display: none;">
                ...
                <form>
                    <div>
                        <input type="text" name="upi_id_first" placeholder="Enter UPI ID" pattern="[a-zA-Z0-9]+@(ybl|axl|ibl|okaxis|oksbi|okhdfc|okicici)$" title="Please enter a valid UPI ID in the format username@bank" minlength="6" maxlength="30" required>
    ...
    <!-- <footer class="footer">
        <div class="section__container footer__bar1">
            ...
            <div class="social">
                ...
                <div class="n_logo"><img src="assets/aireaselogoinwhite.jpg"></div>
            </div>
        </div>
    </footer> -->
    <script>
